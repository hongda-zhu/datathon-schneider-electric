# -*- coding: utf-8 -*-
"""
Schneider Electric Datathon - Explainable Pipeline (Local Version)
End-to-end script that trains XGBoost, generates SHAP assets, and exports JSON insights.
"""
...
# shap.initjs()  # Only needed for Jupyter notebooks
