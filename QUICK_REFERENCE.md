# 🚀 Quick Reference - Datathon Dashboard
...
```
├── app_final.py                          ← Main dashboard (run this)
├── run_final.sh                           ← Quick launcher
├── requirements.txt                       ← Python dependencies
│
├── output/                                ← Generated by Colab
│   ├── model.pkl
│   ├── explainer.pkl
│   ├── X_test.pkl, y_test.pkl
│   ├── shap_values.pkl
│   ├── json/
│   │   ├── global_insights.json           ← Model performance + global SHAP
│   │   └── {id}.json                      ← Per-opportunity analysis
│   └── images/
│       ├── shap_summary.png
...
└── Documentation:
    ...
    ├── DELIVERABLES_VERIFICATION.md       ← Proof of datathon requirements
    ├── IMPROVEMENTS_IMPLEMENTED.md        ← Round 1 improvements
    ├── IMPROVEMENTS_ROUND_2.md            ← Round 2 improvements
...
✅ Fixed contradictory Gemini insights (now mentions opp_old as dominant)
✅ Added probability distribution chart
✅ Added SHAP drivers textual summary
✅ Removed duplicate feature importance visualization
✅ Simplified recommendations display
✅ Better text contrast (#1a1a1a)
✅ Simplified chart explanations

### Round 2 Improvements:
✅ Confidence explanation with threshold distance
✅ Top SHAP factors as text lists
✅ Low/Avg/High context labels for features
✅ Unified confidence logic (threshold-based)
✅ SHAP waterfall text summary
✅ SHAP glossary (expandable)
✅ What-If preset action buttons
✅ Detailed change summary in What-If
✅ Enhanced slider labels with percentiles
...
|----------|-------|------|-----------|
| >40pp | High | ✅ | Green (success-box) |
| 10-40pp | Medium-High | ✅ | Green (success-box) |
| 0-10pp | Medium | ⚠️ | Orange (warning-box) |
| <0pp (below) | Low | ❌ | Orange (warning-box) |

Example:
- Probability: 47.3%
- Threshold: 31.5%
- Distance: 15.8pp → **Medium** confidence

---

## 🎯 What-If Preset Actions

| Button | Effect |
|--------|--------|
| 📈 +20% Interactions | Increases `cust_interactions` by 20% |
| 🎯 Reduce Competitors | Decreases `total_competitors` by 1 |
| ⚡ Fast-Track (New) | Sets `opp_old` to -1.0 (very new) |
| 🔄 Reset to Original | Restores all sliders to original values |
...
1. ✅ **Model performance summary**
   → Global Insights page, metrics with tooltips

2. ✅ **Explainability technique proposal**
   → SHAP (global + local), What-If simulator, tooltips explain usage

3. ✅ **Insights on why Win/Loss**
   → 3 levels: Global patterns, Case-specific drivers, AI recommendations

4. ✅ **LLM interprets SHAP**
   → Gemini generates business insights from SHAP + performance
